...
def fear_greed(): 
    ...
    fear_greed_raw_data = get_all_data_from_bigquery(client=client,dataset_id='shabubsinc_db',table_id='raw_fear_greed_data')
    ...
    try:
        stream_data_to_bigquery(client=client, data=structured_data, project_id='shabubsinc', dataset_id='shabubsinc_db', table_id='processed_fear_greed_data')
