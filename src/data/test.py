...
from ohlc_hourly.ingestion_ohlc.fetch_ohlc_hourly_data import fetch_ohlc_data_from_api,access_secret_version,API_call_limiter, dates 
...
def main():
    ...
    for date in dates:
        ...
        all_call_counts = all_call_counts+1 
